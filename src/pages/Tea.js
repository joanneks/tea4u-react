                  ...
                  <div>
                    <Card style={{ width: '20rem' }} >
                      ...
                      <Card.Body style={{ backgroundColor: '#f7f3f2', height: '265px', padding: '20px' }}>
                        <Card.Title >
                          <div style={{ marginBottom: '8px', paddingLeft: '5px',fontSize:'25px',display:'flex',alignItems:'center'}}>{each.brand.name}
                            ...
                            <span style={{fontSize:'25px', fontWeight: '600', float: 'right' }}>S${each.cost / 100}</span>
                          </div>
                          <div style={{ height: '50px', marginBottom: '30px', paddingLeft: '5px' }}>
                            ...
                            {/* <span style={{ fontSize: 'larger', fontWeight: '600', float: 'right' }}>S${each.cost / 100}</span> */}
